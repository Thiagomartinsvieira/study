...
('Bianca', 'Fonseca', 'bianca@email.com', round(rand() * 100000)),
('Sabrina', 'Lima', 'sabrina@email.com', round(rand() * 100000)),
('Carlinhos', 'Aguiar', 'carlinhos@email.com', round(rand() * 100000)),
('Lucival', 'Andrade', 'lucival@email.com', round(rand() * 100000)),
('Lucas', 'Ribamar', 'ribamar@email.com', round(rand() * 100000));
